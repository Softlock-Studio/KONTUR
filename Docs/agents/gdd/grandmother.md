...
## Overview
Infected elderly woman, experiment participant — **primary current threat**.

- Roams freely most of the night.
...
| ---- | ------------------------ |
| Feed meat with medication at **9:00 and 18:00** | Missed feed → "will seek fresh meat herself" |
| Chain before night cycle | Not chained → "will come looking for you" |
| Contact **at least once per 3 hours** | Increases probability of sudden aggression transitions |
| Red evacuation button under bed | Emergency exit if chains fail |

## Deterrents
- **Iodine-resorcinol-A** — repels her via smell aversion (diégetically grounded).
- Regular contact (per schedule above) reduces aggression.
